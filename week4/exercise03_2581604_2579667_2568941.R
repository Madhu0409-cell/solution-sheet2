...
## Answer: Depending on the sample the confidence interval mean can vary when replicating the experiment over and over.
#        Thus, the mean is not considered as true population mean but as estimated popualation parameter.
...
##    What does this mean?
## Answer: Yes, it does. 
#         The confidence interval generates a lower and upper limit for the mean. 
#         So, the fact that the interval contains the true mean proves the interval estimation is quite precise.
...
bargraph.CI(x.factor = dative$AnimacyOfTheme, response = dative$LengthOfTheme, ci.fun = function(x) {ciMean(x = dative$LengthOfTheme)})
# Answer: 
